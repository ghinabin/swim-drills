...
const CACHE = 'lane50-shell-v19';
const FILES = ['./', 'index.html', 'plan.html', 'session.html', 'drills.html', 'progress.html', 'race.html', 'race-tools.html', 'assets/styles.css', 'assets/interactions.css', 'assets/data.js', 'assets/navigation.js', 'assets/app.js', 'assets/offline.js', 'assets/pickers.js', 'assets/race.js', 'assets/take-your-marks.wav'];
